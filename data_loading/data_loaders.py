...
if S.downsample_user == True:
    ...
    trans_plain_no_ds = transforms.Compose([T.Upsidedown_scipy(), T.Extract_landmark_location(test= True), T.Fix_base_value(), T.Normalise(S.normal_min, S.normal_max, S.normal_window), T.Check_left_right(), T.ToTensor_no_ds()])

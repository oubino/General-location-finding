...
if S.downsample_user == True:
    ...
    trans_augment = transforms.Compose([T.Upsidedown_scipy(),  T.Normalise(S.normal_min, S.normal_max, S.normal_window), T.Shift(), T.Flips_scipy(), T.Horizontal_flip(),  T.Check_left_right(), T.ToTensor()])

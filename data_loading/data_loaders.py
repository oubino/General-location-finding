...
if S.downsample_user == True:
    ...
    trans_plain = transforms.Compose([T.Normalise(S.normal_min, S.normal_max, S.normal_window), T.CentreCrop_test(S.in_z,S.in_x,S.in_y), T.Normalise_final(), T.ToTensor()])# T.Upsidedown_scipy(), T.Check_left_right(),

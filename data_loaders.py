...
for i in range(len(val_set)):
    eval_func.plot_3d_pred_img_no_struc(val_set.__getitem__(i)['image'].unsqueeze(0), S.threshold_img_print, val_path_ct)
...
for i in range(len(test_set)):
    eval_func.plot_3d_pred_img_no_struc(test_set.__getitem__(i)['image'].unsqueeze(0), S.threshold_img_print, test_path_ct)

...
train_folder_name = "train_" + S.epoch_load + '_' + functions.string(S.fold_load)
...
#PATH_sigma1_load = os.path.join(epoch_load, "sigma_1.pt")
#PATH_sigma2_load = os.path.join(epoch_load, "sigma_2.pt")
#PATH_sigma3_load = os.path.join(epoch_load, "sigma_3.pt")
#PATH_sigma4_load = os.path.join(epoch_load, "sigma_4.pt")
